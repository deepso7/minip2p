...
namespace uniffi_generated {
    ...
    */
    ...
    static facebook::jsi::Value __hostFunction_Minip2p_installRustCrate(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
        auto& tm = static_cast<NativeMinip2pSpecJSI&>(turboModule);
...
@implementation Minip2p
RCT_EXPORT_MODULE()

// Don't compile this code when we build for the old architecture.
#ifdef RCT_NEW_ARCH_ENABLED

// Automated testing checks minip2p
// by comparing the whole line here.
/*
- (NSNumber *)multiply:(double)a b:(double)b {
    NSNumber *result = @(minip2p::multiply(a, b));
}
*/
...
{
    return std::make_shared<uniffi_generated::NativeMinip2pSpecJSI>(params);
}
#endif
