...
template <typename T>
class JSI_EXPORT NativeMinip2pCxxSpec : public TurboModule {
public:
  static constexpr std::string_view kModuleName = "Minip2p";
...
private:
  static jsi::Value __installRustCrate(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    ...
    return bridging::callFromJs<bool>(rt, &T::installRustCrate,  static_cast<NativeMinip2pCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));
  }
