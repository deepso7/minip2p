...
/// Edge-triggered notification implemented by a binding shell.
pub trait EventDoorbell: Send + Sync {
    /// Reports that the event carry changed from empty to non-empty.
