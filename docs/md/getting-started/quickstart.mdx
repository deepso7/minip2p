---
title: Connect two local peers
description: Run a listener and dialer in separate terminals, wait for Identify, and measure a libp2p Ping round trip.
---
...
Next, learn [how the endpoint model fits together](/getting-started/mental-model)
or [open an application protocol stream](/guides/custom-protocols).
