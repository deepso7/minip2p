...
The React Native and Node.js native libraries include these capabilities, and
...
events](/react-native/networking-and-events) for configuration examples, and
the [Node API](/reference/node-api) or
[React Native API](/reference/react-native-api) reference for the full
configuration map.
