...
- Driving: focused waits `wait_peer_ready`, `nat_wait_path` (nat), `wait_ping_rtt`; event loops `wait`, `next_event`, `next_wake`; non-blocking `poll`
- Shutdown: `close`
...
- Attempts: `nat_connect`, `nat_connect_addr`, `nat_connect_with_addrs`, `nat_cancel_connect`, `nat_wait_path`
...
- Events: `take_gossipsub_events`, `next_gossipsub_event`
