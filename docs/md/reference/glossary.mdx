...
| Term | Meaning |
| --- | --- |
| **Endpoint** | App-facing entrypoint that owns identity, transports, and the swarm driver. Std form uses sockets; portable form is caller-driven. See [Concepts](/rust/concepts#endpoint). |
