...
[where events go](/rust/guides/concepts#where-events-go) first. If you are working
with custom streams, also read [Register a protocol](/rust/guides/register-a-protocol).
