...
[`PeerReady`](/rust/guides/concepts#connection-readiness).
...
them, the same way [Connect two peers](/rust/quickstart/connect-peers) does.
...
Next: [Drive events](/rust/guides/drive-events).
